...
// 1. Required Parameter
function greeting1(name: string, nickName: string) {
  console.log(`Hello ${name} ${nickName}`);
}
// greeting1("nasir", "Alexender");

// 2. Optional Parameter
function greeting2(name: string, nickName?: string) {
  console.log(`Hello ${name} `, nickName);
}
//greeting2("nasir");

// 3. Default Parameter
function greeting3(name: string = "Dear Alexender") {
  console.log(`Hello ${name} `);
}
//greeting3();
...
function greeting4(name: string, ...nickName: string[]) {
  console.log(`Hello ${name} ${nickName}`);
}
